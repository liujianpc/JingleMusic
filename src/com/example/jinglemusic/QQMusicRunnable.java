...
public class QQMusicRunnable implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            JSONObject jsonObject = new JSONObject(getJsonByGet(url));
            ...
            for (int i = 0; i < jsonArray.length(); i++) {
                ...
                String json =  JsonpUtil.parseJSONP(getJsonByGet("http://base.music.qq.com/fcgi-bin/fcg_musicexpress.fcg?json=3&loginUin=0&format=jsonp&inCharset=GB2312&outCharset=GB2312&notice=0&platform=yqq&needNewCode=0"));
